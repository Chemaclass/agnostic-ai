...
| **cursor**      | as `.mdc` (alwaysApply: false) | as `.mdc` (`skill-<name>.mdc`) | `.cursor/rules/*.mdc` | - | `.cursor/mcp.json` | `.cursor/commands/<name>.md` | - | `BUGBOT.md` (per scope) | `.cursor/environment.json` | `.cursorignore` |
