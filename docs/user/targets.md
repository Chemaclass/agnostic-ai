...
| **warp**        | inlined in `AGENTS.md` | listed in `AGENTS.md` | `AGENTS.md` (nested per-dir by scope/globs) | - | - |
...
Config keys: `outputs.amp.file` (default `AGENTS.md`), `outputs.amp.commands-dir` (default `.agents/commands`), `outputs.amp.emit-skills-as-commands` (default `false`).
...
Config key: `outputs.warp.file` (default `AGENTS.md`).
