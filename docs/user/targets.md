...
| **windsurf**    | as `.md` rule (+ `.windsurf/workflows/<name>.md` w/ opt-in) | `.agents/skills/<name>/SKILL.md` | `.devin/rules/*.md`      | -     | `.devin/mcp_config.json` | - | - | - | - | `.devinignore` |
