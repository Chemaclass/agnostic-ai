...
- Provenance header shortened to `Generated by agnostic-ai` (drop `. Do not edit by hand.`). Cuts visual weight in every generated file. Detection marker unchanged, so importers and legacy-file migration still recognize files emitted by older versions.
