...
- `docs/user/spec-format.md` listed two targets as having no project-scoped MCP file where the registry has five, and `targets.md` omitted Antigravity from the targets honouring `disabled` (#597).
