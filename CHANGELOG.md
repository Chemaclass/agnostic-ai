...
- The hero fan draws itself once and then stays. The target names and their endpoint dots hold at full opacity for good, and a pulse keeps travelling the rails behind them, so there is no longer a stretch of every loop with nothing to read.
