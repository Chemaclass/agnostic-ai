...
- docs: https://docs.github.com/en/copilot/reference/custom-agents-configuration.md · https://docs.github.com/en/copilot/how-tos/copilot-on-github/customize-copilot/customize-cloud-agent/add-skills.md · https://code.visualstudio.com/docs/agent-customization/mcp-servers (MCP; VS Code's docs are authoritative for `.vscode/mcp.json`, docs.github.com does not cover it) · https://docs.github.com/en/copilot/how-tos/copilot-cli/customize-copilot/add-mcp-servers.md (the Copilot CLI MCP page; this is the one that names the accepted top-level keys) · https://docs.github.com/en/copilot/reference/copilot-cli-reference/cli-config-dir-reference.md (Copilot CLI user, repository, and local settings plus repository model policy) · https://code.visualstudio.com/docs/agents/reference/mcp-configuration (the VS Code-only MCP fields `targets/copilot.md` cites) · https://docs.github.com/en/copilot/concepts/agents/hooks.md · https://docs.github.com/en/copilot/reference/hooks-reference.md (14 events) · https://docs.github.com/en/copilot/how-tos/copilot-on-github/customize-copilot/customize-cloud-agent/use-hooks.md (the default-branch requirement)
...
- docs: https://docs.cline.bot/customization/cline-rules.md · /customization/skills.md · /getting-started/config.md (append `.md` to any path for a clean markdown mirror; `llms.txt` lists every page)
...
- docs: https://docs.augmentcode.com/setup-augment/guidelines.md · https://docs.augmentcode.com/cli/subagents.md · /cli/config.md · /cli/rules.md · /cli/skills.md · /cli/hooks.md · /cli/custom-commands.md · /cli/integrations.md · https://docs.augmentcode.com/cli/permissions.md (repository `toolPermissions` in `.augment/settings.json`; append `.md` to any path for a markdown mirror)
...
- docs: https://docs.qoder.com/user-guide/rules.md · https://docs.qoder.com/extensions/subagent.md · https://docs.qoder.com/extensions/skills.md · https://docs.qoder.com/cli/subagent.md · https://docs.qoder.com/cli/mcp-servers.md · https://docs.qoder.com/cli/Skills.md · https://docs.qoder.com/user-guide/chat/model-context-protocol.md · https://docs.qoder.com/cli/mcp-reference.md · https://docs.qoder.com/cli/hooks-reference.md · https://docs.qoder.com/cli/hooks.md · https://docs.qoder.com/cli/commands.md · https://docs.qoder.com/user-guide/commands.md · https://docs.qoder.com/cli/settings.md (the canonical page for `.qoder/settings.json`, and the source of the JSONC statement behind #725) · https://docs.qoder.com/cli/permissions.md (project `permissions.allow`, `permissions.deny`, and `permissions.ask`) · https://docs.qoder.com/cli/settings-reference.md (every `settings.json` key with type, default, and whether it needs a restart; the fastest way to spot a new block) · https://docs.qoder.com/cli/config-scope.md (which of the three files a key belongs in: `~/.qoder/settings.json`, `<project>/.qoder/settings.json`, `<project>/.qoder/settings.local.json`) · https://docs.qoder.com/cli/memory.md (the auto-memory store paths; `docs/site/content/docs/target-behavior.md` claims Qoder cannot relocate it, and that claim had no tracked page until 2026-09-22)
...
- docs: https://docs.factory.ai/harness/subagents.md · /harness/skills.md · /harness/hooks.md · /harness/custom-slash-commands.md · /harness/mcp.md · /droid-cli/settings.md (the `settings.json` **key** reference: every key, its options, and its default. Its own location table lists `~/.factory/settings.json` alone. **Do not read that as a user-tier-only file and stop**, which is how this pairing hid the missing project-tier emitter for three runs) · /enterprise/hierarchical-settings-and-org-control.md (**the page that settles the project tier, and it is real**: "Settings are authored in `.factory/` folders, using the **same schema** at every level", with the levels table row "| **Project** | `<git-root>/.factory/` | Repo maintainers |" and "Each `.factory/` folder can contain: - `settings.json`: general settings (models, safety, preferences, telemetry)." Corroborated on /harness/skills: "The **User** tab writes the choice to `disabledSkills` in `~/.factory/settings.json`; the **Project** tab writes to `<project>/.factory/settings.json`." Read this page for scope and `/droid-cli/settings` for keys, never the reverse. It carries the org-managed schema and the precedence order too, and the org half stays out of our reach) · /enterprise/llm-safety-and-agent-controls.md (**the only page with the command-pattern examples**, and the one that names the sandbox's extra network keys) · https://docs.factory.ai/autonomy-and-safety/sandbox.md (the `sandbox.*` full reference; the hierarchical page is captioned "Where `sandbox.*` lives") · https://docs.factory.ai/ (append `.md` to any path for a markdown mirror)
