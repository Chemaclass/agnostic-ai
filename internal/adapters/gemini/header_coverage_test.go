...
// TestEmit_ProvenanceHeaderOnEveryEmittedFile is the gemini adapter's
// header-coverage contract: every TOML and Markdown file the adapter
// writes must carry the agnostic-ai provenance marker.
// .gemini/settings.json is JSON-exempt. Hook scripts are verbatim
// user-authored bodies and skip.
