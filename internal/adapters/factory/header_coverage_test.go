...
func kitSinkBundle() spec.Bundle {
	entries := []spec.Entry{
		...
		{Kind: spec.KindAgent, Name: "gamma", Path: "agents/gamma.md", Meta: map[string]any{"description": "handles gamma", "tools": []any{"Read", "Bash", "Write", "WebFetch", "Task"}}, Body: "gamma body"},
		{
