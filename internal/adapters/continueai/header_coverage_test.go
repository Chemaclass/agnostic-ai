...
// TestEmit_ProvenanceHeaderOnEveryEmittedFile is the continue
// adapter's header-coverage contract: every Markdown and YAML file
// the adapter writes must carry the agnostic-ai provenance marker.
