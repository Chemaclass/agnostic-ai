...
// a junie sync over the canonical kit-sink bundle (3 rules + 3
// agents + 3 skills + 1 MCP server).
//
//	UPDATE_GOLDEN=1 go test ./internal/adapters/junie/ -run TestKitSink_GoldenSnapshot
