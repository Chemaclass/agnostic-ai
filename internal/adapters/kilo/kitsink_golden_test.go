...
// kilo sync over the canonical kit-sink bundle (3 rules + 3 agents + 3
// MCPs), even though rules never land on disk through this adapter.
//
...
//
//	UPDATE_GOLDEN=1 go test ./internal/adapters/kilo/ -run TestKitSink_GoldenSnapshot
