...
// a cursor sync over the canonical kit-sink bundle (3 rules + 3
// agents + 3 skills + 3 MCPs) with commands-dir opted in.
//
//	UPDATE_GOLDEN=1 go test ./internal/adapters/cursor/ -run TestKitSink_GoldenSnapshot
