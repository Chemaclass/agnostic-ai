...
// Native cursor skills (folder + bundled assets) and commands round-trip
// into the source dirs so sync can re-emit them everywhere.
func TestImportFromCursor_SkillsAndCommands(t *testing.T) {
	dir := t.TempDir()
