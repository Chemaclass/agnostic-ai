...
- `/agent-setup.txt` gives coding agents one plain-text setup and migration contract generated from the canonical user guide. The public site and README expose the same ready-to-paste prompt.
